...
class UserMedia(db.Model):
    ...
    def __init__(self, user_id, media_type, cinema_id=None, book_id=None, music_id=None, done=False, planned=False, date_consumed=None, review=None, rating=None, tags=None):
